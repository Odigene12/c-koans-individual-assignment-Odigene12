...
namespace DotNetKoans.CSharp
{
    ...
    public class AboutMethods : Koan
    {
        ...
        {
            string[] men = new string[] { "Cory", "Will", "Corey" };
            Assert.Equal(men, LocalMethodWithVariableParameters("Cory", "Will", "Corey"));
        }
        ...
        {
            string[] men = new string[] { "Cory", "Will", "Corey" };
            Assert.Equal(men, this.MethodWithVariableArguments("Cory", "Will", "Corey"));
        }
