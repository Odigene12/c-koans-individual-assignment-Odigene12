...
namespace DotNetKoans.CSharp
{
    public class AboutControlStatements : Koan
    {
        ...
        public void ContinueStatement()
        {
            ...
            var newresult = new List<int>() { 1, 3, 5, 7, 9 };
            Assert.Equal(newresult, result);
        }
        ...
        public void ForStatement()
        {
            ...
            var newlist = new List<string> { "FISH", "AND", "CHIPS" };
        ...
        public void ForEachStatement()
        {
            ...
            var newfinallist = new List<string> { "FISH", "AND", "CHIPS" };
            var newlist = new List<string> { "fish", "and", "chips" };
            Assert.Equal(newlist, list);
            Assert.Equal(newfinallist, finalList);
        }
